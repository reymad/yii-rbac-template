...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='post table';

#
# Data for table "post"
#

INSERT INTO `post` VALUES (1,'test','test',NULL,'es-ES',8,1488466870,1488466870,10),(2,'another post','kajdlkajsdlkasjdaslkdjasd',NULL,'es-ES',8,1488468058,1488468058,10),(3,'adsfasfasdf','afdsfasdfasdfasdf',NULL,'es-ES',8,1488469733,1488469733,10),(4,'post fb user','post fb user',NULL,'es-ES',7,1488473812,1488473812,10),(5,'Another fb user post','Another fb user post',NULL,'es-ES',7,1488475166,1488475166,10);
